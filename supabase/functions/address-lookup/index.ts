...
serve(async (req) => {
  ...
  try {
    ...
    // Fix: Using only valid type values for Geoapify API
    // Using 'street' which is a valid value according to Geoapify docs
    url.searchParams.append("type", "street");

    console.log(
      "Calling Geoapify API with URL:",
    ...
    console.error(
      "Error in address-lookup function:",
