...
-- 2. Create packaging_intelligence_reports table
...
-- Create RLS policies for order_packaging_recommendations
...
-- Create RLS policies for packaging_intelligence_reports
...
-- Create RLS policies for packaging_alerts  
...
CREATE INDEX IF NOT EXISTS idx_packaging_alerts_company_unresolved ON public.packaging_alerts(company_id, is_resolved) WHERE is_resolved = FALSE;