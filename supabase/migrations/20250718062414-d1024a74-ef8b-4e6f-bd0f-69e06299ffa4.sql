-- Fix the user assignment to use the active Demo company
UPDATE users 
SET company_id = '15ca372c-95fe-4226-908c-8313f1942e0f'
WHERE email = 'fetters@gmail.com';

-- Fix the handle_new_user function to use the active Demo company
