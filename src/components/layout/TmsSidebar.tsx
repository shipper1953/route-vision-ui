  ...
  return (
    <div className={cn(
      ...
      <div className="flex-1 overflow-auto py-4 px-2 flex flex-col gap-1">
        ...
        <NavItem to="/shipments" icon={Package} label="Shipments" isCollapsed={isCollapsed} />
        <NavItem to="/fleet" icon={Truck} label="Fleet" isCollapsed={isCollapsed} />
        <NavItem to="/schedule" icon={Calendar} label="Schedule" isCollapsed={isCollapsed} />
        <NavItem to="/analytics" icon={BarChart3} label="Analytics" isCollapsed={isCollapsed} />
        <NavItem to="/customers" icon={User} label="Customers" isCollapsed={isCollapsed} />
